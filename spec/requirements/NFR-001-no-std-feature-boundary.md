...
|---|---|---|
| NFR-001-AC-1 | The default feature graph has no normal dependency and exposes the borrowed formula API. | Test (TC-019) |
| NFR-001-AC-2 | The crate compiles with no default feature, alloc only, serde, and all features. | Test (TC-019) |
