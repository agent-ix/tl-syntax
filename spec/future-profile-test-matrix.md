...
| TC-147 | Trace a registered backend's evidence to the exact canonical graph and TL profile identity under every settlement label; inspect TL-15 / STD-13 / TL-13 / TL-7 order and accepted-spec gate | Integration | P0 | FR-291-AC-1, FR-291-AC-2, FR-291-AC-3 | 🚧 planned |
