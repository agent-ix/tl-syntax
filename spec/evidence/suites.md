...
| SUITE-003 | Strict requirement coverage | `python3 scripts/check_traceability_coverage.py` | quire 0.31.0 / quire-rs 0.46.0 plus repository completeness policy | Analysis |
