...
| NFR-003 | NFR-003-AC-1 through NFR-003-AC-6 | TC-021, TC-022, TC-025, TC-026, TC-034, TC-035, TC-038, TC-039 | 🚧 planned |
...
| TC-039 | Bind hosted CI to the released scoped ix-flow package while retaining its executable version and manual-only trigger | Integration | P0 | NFR-003-AC-6 | 🚧 planned |
