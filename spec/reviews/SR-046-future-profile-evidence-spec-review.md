...
|---|---|---|---|
| FND-4601 | medium | The initial matrix covered malformed parser forms only through integration/property rows although the advisor recommends fuzzing. Fixed by adding TC-047 as a bounded no-unwind v2-dialect fuzz obligation. | FR-009-AC-1, FR-009-AC-4, TC-047 |
