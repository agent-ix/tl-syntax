...
| FND-3602 | medium | No `Fuzz` matrix row or grounded fuzz obligation exists yet. A serde decoding target must be specified and reviewed before a harness is introduced; a fuzz campaign is not inferred from a property-test issue. | FR-004, FR-007, TM-001 |
