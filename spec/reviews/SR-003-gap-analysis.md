...
|---|---|---|---|
| FND-301 | low | The installed process module's coverage classifier expects `Status`, while its structurally validated functional and stakeholder table contracts require `Coverage Status`; aggregate status classification is advisory-skipped, but all underlying criterion and test rows remain independently backed. | TM-001, SUITE-003 |
