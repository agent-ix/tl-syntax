...
| FND-5702 | low | “Fixed-sample time” was vague about interval units and conversion. Fixed by defining sample(n)=epoch+n*period in one opaque owner-supplied unit with checked exact arithmetic and distinct incomplete/refusal outcomes. | FR-012-AC-5 |
