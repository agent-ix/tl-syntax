...
| FND-5202 | low | Eight new live specification/routing/schema artifacts change the exact tracked-source partition while these eight SpecReviews remain archival. Fixed by updating the expected array and spec-area count; a one-count mutation makes the census fail. | tests/shared_assurance.rs |
