...
| --- | --- | --- | --- | --- |
| FND-7301 | low | No remaining M6 EARS or requirement-atomicity defect was found. The implementation-dependent clauses remain conditional on their named released contracts. | FR-014..FR-018, NFR-004..NFR-005 | correct-requirement-no-evidence |
