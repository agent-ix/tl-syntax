...
| FND-7402 | low | Review and plan Markdown remain deliberately archival so adding an independent review cannot invalidate the exact source population it reviewed. Executable content still belongs to the separate FR-019 exhaustive invocation census. | FR-019, source census | correct-requirement-no-evidence |
