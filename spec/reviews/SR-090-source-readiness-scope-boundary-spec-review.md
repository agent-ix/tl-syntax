...
scope: "MRS-004, StR-003, StR-004, FR-015..FR-019, NFR-004..NFR-005, AD-002"
review_set: all
---
...
| --- | --- | --- | --- | --- |
| FND-6401 | medium | LR08 inventory and shared Rust producer execution remain cross-repository responsibilities; tl-syntax may enumerate and classify its paths but may not invent a local runner, source language, evidence store or qualification framework. | quire-research#64, engineering-assurance#34, FR-019, AD-002 | correct-requirement-no-evidence |
