...
| --- | --- | --- | --- | --- |
| FND-5901 | medium | Real failure-path evidence cannot exist until the released source-grounding, retention, reviewer-policy and integrator-package dependencies are selected; the correct current result is unavailable or blocked, not a local substitute. | tl-syntax#16, FR-015-AC-4, FR-016-AC-5, FR-017-AC-4, FR-018-AC-6 | correct-requirement-no-evidence |
