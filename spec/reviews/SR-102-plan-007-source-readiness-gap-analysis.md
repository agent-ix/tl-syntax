...
scope: "spec/plans/PLAN-007-source-qualification-readiness/, spec/source-readiness-test-matrix.md, source and tests at 7a3d15b"
review_set: subset
relationships:
...
- Target plan: `spec/plans/PLAN-007-source-qualification-readiness/`.
