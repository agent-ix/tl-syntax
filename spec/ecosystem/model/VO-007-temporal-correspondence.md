...
- **source_set** — exact immutable native definition, observation context and producer-result artifacts.
- **derived_set** — exact predicate projection, TL artifact set and consumer-owned canonical bytes/identities.
