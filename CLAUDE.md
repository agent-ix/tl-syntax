...
- `Cargo.toml` declares Rust 1.75 as the MSRV; the manual workflow checks every
  target at that version while `rust-toolchain.toml` selects stable rustfmt and clippy.
